...
# Follow symbolic links when accessing files and directories if this flag is nonzero
# Keep this disabled for security reasons unless required
follow_symlinks=0

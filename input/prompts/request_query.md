...
- If the request category is determined by a combination of multiple fields, treat the combination as a single identifying key and describe those fields together (comma-separated) in the `field_name` value.

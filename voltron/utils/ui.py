...
def make_runtime_table():
    ...
    data = {
        ...
        'lifetime response events': ana.lifetime_res_events_num(),
        'lifetime response types': ana.lifetime_res_types_num(),
        'lifetime transition events': ana.lifetime_resp_trans_events_num(),
        'lifetime transitions': ana.lifetime_resp_trans_num(),
        'state num': ana.state,
...
def make_progress_panel():
    ...
    elif analyzer.show_progress == 'berserker':
        data = {

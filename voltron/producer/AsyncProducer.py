...
class AsyncProducer:
    ...
    def __init__(
        ...
        self.producer_path = configs.base_path / 'output' / 'equipment' 
        self.target_p_path = configs.base_path / configs.target_name
        ...
        if (not self.target_p_path.is_dir()):
            self.target_p_path.mkdir()

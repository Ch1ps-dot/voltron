...
def generate() -> bytes:
    ...
    choice = random.choice(["null", "simple", "with_at_domain", "with_at_domain_multi", "local_underscore", "local_dotted", "local_quoted", "path_max_len", "path_minimal", "local_with_hyphen", "domain_with_hyphen", "null_case"])
